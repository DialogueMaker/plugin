...
This button is enabled if you are selecting an instance *and* not selecting a ModuleScript with a "DialogueMaker_Conversation" tag or a "DialogueMaker_Dialogue" tag.
...
This button is enabled if you are currently a ModuleScript with a "DialogueMaker_Conversation" tag or a "DialogueMaker_Dialogue" tag.
