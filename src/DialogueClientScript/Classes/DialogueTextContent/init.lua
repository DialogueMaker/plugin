...
local IDialogueTextContent = require(DialogueClientScript.Interfaces.DialogueTextContent);

type DialogueTextContent = IDialogueTextContent.DialogueTextContent;
type Page = IDialogueContentFitter.Page;

local DialogueTextContent = {};

function DialogueTextContent.new(textLabel: TextLabel, text: string): DialogueTextContent
  
  local function getPages(self: DialogueTextContent, contentContainer: GuiObject, pages: {string}, currentPageComponents: {string}): {Page}
    ...
    repeat
      ...
      if textLabel.TextFits then
        ...
        local function getLineBreakPositions(text: string): {number}
          ...
          for _, component in currentPageComponents do
        ...
        if lastLineBreakIndex then
          ...
          table.insert(currentPageComponents, paragraphTextLabel.Text);
        ...
        table.insert(currentPageComponents, textLabel.Text);
